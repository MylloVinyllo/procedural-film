// STUB
// Placeholder for shot 12 'create-contribute' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  ...
  draw(ctx, t, info) {
    ...
    const seed = L.hash('create-contribute');
    L.paper(ctx);
    ...
    L.text(ctx, 'STUB 12', 540, 330, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'create-contribute', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'create-contribute', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
