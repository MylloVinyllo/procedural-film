// STUB
// Placeholder for shot 11 'bond' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'bond',
  draw(ctx, t, info) {
    ...
    L.text(ctx, 'STUB 11', 540, 330, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'bond', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'bond', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
