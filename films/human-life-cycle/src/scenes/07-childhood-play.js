// STUB
// Placeholder for shot 07 'childhood-play' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'childhood-play',
  draw(ctx, t, info) {
    ...
    const seed = L.hash('childhood-play');
    L.paper(ctx);
    ...
    L.text(ctx, 'STUB 07', 540, 330, { size: 60, weight: 600, align: 'center', color: P.annMagenta });
    L.text(ctx, info.shot.title || 'childhood-play', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'childhood-play', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
