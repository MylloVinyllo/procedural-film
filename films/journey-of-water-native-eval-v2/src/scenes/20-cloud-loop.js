...
(function(){
  ...
  function cloudLobe(c,L,P,o,t,idx){
    ...
    c.save();c.globalAlpha=o.alpha;c.fillStyle=P[o.fill] || o.fill;c.beginPath();L.tracePath(c,pts,true);c.fill();
  ...
  const back=[
    {x:90,y:330,rx:245,ry:205,fill:'cloudBackA',alpha:.55,phase:.2,drift:14},
    {x:350,y:285,rx:275,ry:225,fill:'cloudBackB',alpha:.62,phase:.8,drift:13},
    {x:675,y:320,rx:300,ry:235,fill:'cloudBackC',alpha:.6,phase:1.2,drift:14},
    {x:970,y:390,rx:270,ry:220,fill:'cloudBackD',alpha:.6,phase:1.6,drift:14},
    {x:180,y:650,rx:290,ry:245,fill:'cloudBackE',alpha:.67,phase:.5,drift:16},
    {x:860,y:690,rx:320,ry:260,fill:'cloudBackF',alpha:.66,phase:1.1,drift:15}
  ];
  const mid=[
    {x:55,y:950,rx:265,ry:235,fill:'cloudMidA',alpha:.84,phase:.7,drift:19,hatch:9},
    {x:320,y:940,rx:285,ry:230,fill:'cloudMidB',alpha:.87,phase:1.5,drift:18,hatch:9},
    {x:765,y:935,rx:305,ry:245,fill:'cloudMidC',alpha:.88,phase:.1,drift:18,hatch:9},
    {x:1040,y:965,rx:270,ry:225,fill:'cloudMidD',alpha:.82,phase:1.8,drift:17,hatch:9},
    {x:165,y:1200,rx:250,ry:220,fill:'cloudMidE',alpha:.86,phase:.35,drift:19,hatch:10},
    {x:905,y:1190,rx:285,ry:235,fill:'cloudMidF',alpha:.86,phase:1.35,drift:18,hatch:10}
  ];
  const front=[
    {x:-60,y:1510,rx:330,ry:275,fill:'cloudFrontA',alpha:.93,phase:.2,drift:24,hatch:9,outline:2.2},
    {x:1140,y:1490,rx:360,ry:290,fill:'cloudFrontB',alpha:.93,phase:1.2,drift:23,hatch:9,outline:2.2},
    {x:310,y:1710,rx:300,ry:230,fill:'cloudFrontC',alpha:.9,phase:.65,drift:22,hatch:10,outline:2},
    {x:800,y:1735,rx:330,ry:245,fill:'cloudFrontD',alpha:.91,phase:1.55,drift:21,hatch:10,outline:2}
  ];
