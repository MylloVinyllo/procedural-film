...
FILM.scene({
  id:'tributary-river',
  draw(ctx,t,info){
    const L=info.lib,P=L.pal,p=L.clamp(t/info.dur),q=L.clamp(L.onTwos(t)/info.dur),seed=L.hash('tributary-river');
    ...
    L.text(ctx,'STUB 10',540,330,{size:60,weight:600,align:'center',color:P.annMagenta});
    L.text(ctx,info.shot.title||'tributary-river',540,1420,{size:44,align:'center',color:P.ink});
