...
FILM.scene({
  id:'rain-fall',
  draw(ctx,t,info){
    const L=info.lib,P=L.pal,p=L.clamp(t/info.dur),q=L.clamp(L.onTwos(t)/info.dur),seed=L.hash('rain-fall');
    ...
    L.text(ctx,info.shot.title||'rain-fall',540,1420,{size:44,align:'center',color:P.ink});
