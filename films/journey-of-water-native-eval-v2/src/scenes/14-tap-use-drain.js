...
FILM.scene({
  id:'tap-use-drain',
  draw(ctx,t,info){
    const L=info.lib,P=L.pal,p=L.clamp(t/info.dur),q=L.clamp(L.onTwos(t)/info.dur),seed=L.hash('tap-use-drain');
    ...
    L.text(ctx,info.shot.title||'tap-use-drain',540,1420,{size:44,align:'center',color:P.ink});
